...
class SN8TestDataset(SN8Dataset):
    def __init__(self,
                csv_filename,
                 data_to_load: List[str] = ["preimg","postimg","building","road","roadspeed","flood"],
                 img_size: Tuple[int, int] = (1300,1300),
...
# class SN8TestDataset(SN8Dataset):
#     def __init__(self, csv_filename: str, data_to_load: List[str] = ["preimg", "postimg", "building", "road", "roadspeed", "flood"], img_size: Tuple[int, int] = (1300, 1300), transforms=None):
#         super().__init__(csv_filename, data_to_load, img_size, transforms)
...
if __name__ == "__main__":
    ...
    test_dataset = SN8TestDataset("areas_of_interest/test_data.csv",
